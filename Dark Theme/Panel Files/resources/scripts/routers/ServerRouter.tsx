                    ...
                    <CSSTransition timeout={150} classNames={'fade'} appear in>
                        <SubNavigation>
                            <div>
                                ...
                                <Can action={'file.*'}>
                                    <NavLink to={`${match.url}/files`}><FontAwesomeIcon className="listicon" icon={faFile}/><span className="navigationtext">File Manager</span></NavLink>
                                </Can>
                                <Can action={'database.*'}>
                                ...
                                <Can action={'schedule.*'}>
                                    <NavLink to={`${match.url}/schedules`}><FontAwesomeIcon className="listicon" icon={faCalendarAlt}/><span className="navigationtext">Schedules</span></NavLink>
                                </Can>
                                <Can action={'user.*'}>
                                    <NavLink to={`${match.url}/users`}><FontAwesomeIcon className="listicon" icon={faUser}/><span className="navigationtext">Users</span></NavLink>
                                </Can>
                                <Can action={'backup.*'}>
                                ...
                                <Can action={'allocation.*'}>
                                    <NavLink to={`${match.url}/network`}><FontAwesomeIcon className="listicon" icon={faNetworkWired}/><span className="navigationtext">Network</span></NavLink>
                                </Can>
                                <Can action={'startup.*'}>
                                    <NavLink to={`${match.url}/startup`}><FontAwesomeIcon className="listicon" icon={faPlayCircle}/><span className="navigationtext">Startup</span></NavLink>
                                </Can>
                                <Can action={['settings.*', 'file.sftp']} matchAny>
                                    <NavLink to={`${match.url}/settings`}><FontAwesomeIcon className="listicon" icon={faCogs}/><span className="navigationtext">Settings</span></NavLink>
                                </Can>
                                {rootAdmin &&
